...
Every UML Enumeration element have to specify the constraint level as a tag, using a datatype property of choice for that purpose (set in configuration). 
