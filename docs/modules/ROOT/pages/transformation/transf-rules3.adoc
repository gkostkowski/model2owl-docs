...
[source,XML]
----
<rdf:Description rdf:about = "http://base.shape.uri/EnumName">
  <rdf:type rdf:resource = "http://...shacl#NodeShape"/>
  <sh:targetClass rdf:resource = "http://...skos/core#ConceptScheme"/>
</rdf:Description>
----
...
<rdf:Description rdf:about = "http://base.shape.uri/EnumName-itemShape">
  <rdf:type rdf:resource = "http://...shacl#NodeShape"/>
  <sh:targetClass rdf:resource = "http://...skos/core#Concept"/>
</rdf:Description>
----
|
