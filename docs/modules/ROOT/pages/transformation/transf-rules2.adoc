...
Within the SHACL PropertyShape corresponding to a dependency relation linked to a given source UML Class, specify a NodeShape constraining the range of the dependency. Refer to a node shape for an enumeration item as defined in the xref:./transf-rules3.adoc#rule:enumeration-item-ds[transformation rule for enumeration item].
====
...
shape:ClassName-relationName a sh:PropertyShape ;
    sh:path :relationName;
    sh:node shape:EnumerationName-itemShape .
----
|
.Property class constraint in RDF/XML syntax
[source,XML]
...
<rdf:Description rdf:about="http://base.shape.uri/ClassName-relationName">
  ...
  <sh:path rdf:resource="http://base.onto.uri/relationName"/>
  <sh:node rdf:resource="http://base.shape.uri/EnumerationName-itemShape"/>
</rdf:Description>
----
|===
